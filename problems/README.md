...
| 5  | Top K Frequent Elements  | [🔗](https://leetcode.com/problems/top-k-frequent-elements/)| Hashing, Heap, Bucket | Medium   | Frequency map + heap or bucket approach [View](./easy/347-top-k-frequent-elements/README.md) |
| 6  | Valid Sudoku             | [🔗](https://leetcode.com/problems/valid-sudoku/)         | Hashing, Matrix       | Medium     | Row/col/box uniqueness validation [View](./medium/valid-sudoku/README.md)               |
| 7  | Product of Array Except Self | [🔗](https://leetcode.com/problems/product-of-array-except-self/) | Prefix/Suffix Arrays  | Medium     | Prefix & suffix products; in-place optimization [View](./medium/238-product-of-array-except-self/README.md) |
| 8  | Longest Consecutive Sequence | [🔗](https://leetcode.com/problems/longest-consecutive-sequence/) | Hashing, Set          | Medium     | Track sequences only from start of streaks using HashSet [View](./medium/128-longest-consecutive/README.md) |
